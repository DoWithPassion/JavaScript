...
-  A function which takes a function as an argument or returns a function from it is called Higher order function.
```
function x(){
 console.log("Namaste");
}
...
```
- It helps us to write the modular program or reusable code.
Eg: Always try to follow DRY.
- Calculate area for the given radii of circle
- Calculate the circumference of given radii of circle
- Calculate the diameter of given radii of circle
```
const radii = [3,1,2,4]
...
```
- Making above function some what similar to map using Array.prototype
```
const radii = [3,1,2,4]
const area = function(radius){
  return Math.PI * radius * radius
...
```
- A function that was passed to the higher order function is called callback.
